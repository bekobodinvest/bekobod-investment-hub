        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-xs text-[#4a9c4e] hover:text-white font-medium bg-[#4a9c4e]/10 hover:bg-[#4a9c4e] rounded-lg px-3 py-2 transition-colors"
            >
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center bg-white hover:bg-gray-50 px-4 py-2.5 rounded-xl transition-all duration-200 shadow-lg whitespace-nowrap"
            >
              <Image
