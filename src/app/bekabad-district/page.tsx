      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-[#1a2744] to-[#1a3530] relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-300 leading-relaxed text-lg text-justify indent-8">{d.overview.description}</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {d.economy.items.map((item, i) => (
              ...
              >
                ...
                <p className="text-gray-500 text-sm leading-relaxed text-justify indent-8">{item.note}</p>
              </div>
            ))}
          </div>
