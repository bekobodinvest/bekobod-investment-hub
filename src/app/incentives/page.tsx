      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-[#1a2744] to-[#243660] relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-300 leading-relaxed text-lg text-justify indent-8">{t.incentives.overview.description}</p>
          </div>
        </div>
      </section>
          ...
          <div className="animate-on-scroll bg-gradient-to-r from-[#1a2744] to-[#243660] rounded-[2rem] p-8 text-white">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed text-justify indent-8">{t.incentives.property.note}</p>
              </div>
            </div>
          </div>
