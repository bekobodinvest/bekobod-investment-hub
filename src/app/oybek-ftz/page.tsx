        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-end">
            <div className="pb-16">
              ...
              <p className="text-gray-300 leading-relaxed text-lg text-justify indent-8">{t.oybek.overview.description}</p>
            </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-on-scroll order-1 lg:order-2">
              ...
              <p className="text-gray-600 leading-relaxed text-justify indent-8">{t.oybek.location.description}</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {t.oybek.facilities.items.map((facility, i) => (
              ...
              >
                ...
                <p className="text-gray-500 text-sm leading-relaxed text-justify indent-8">{facility.description}</p>
              </div>
            ))}
          </div>
        </div>
