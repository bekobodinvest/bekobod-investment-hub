  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <p className="text-gray-500 text-sm leading-relaxed mb-5 text-justify indent-8">{description}</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reasons.map((reason, i) => (
              ...
              >
                ...
                <p className="text-gray-500 text-sm leading-relaxed text-justify indent-8">{reason.description}</p>
              </div>
            ))}
          </div>
        </div>
