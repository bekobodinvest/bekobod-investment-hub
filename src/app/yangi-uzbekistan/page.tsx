        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-end">
            <div className="pb-16">
              ...
              <p className="text-gray-300 leading-relaxed text-lg text-justify indent-8">{t.yangi.overview.description}</p>
            </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-on-scroll">
              ...
              <p className="text-gray-600 leading-relaxed text-lg mb-6 text-justify indent-8">
              ...
              <div className="p-6 bg-gradient-to-br from-[#1a2744] to-[#243660] rounded-[2rem]">
                ...
                <p className="text-gray-300 text-sm leading-relaxed text-justify indent-8">{t.yangi.concept.description}</p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {(['🏙️', '🎓', '🌳'] as const).map((icon, i) => (
              ...
              >
                ...
                <p className="text-gray-500 leading-relaxed text-justify indent-8">{t.yangi.highlights[i].description}</p>
              </div>
            ))}
          </div>
        </div>
