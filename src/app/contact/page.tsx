        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* E-Auction Card */}
              <div className="animate-on-scroll bg-gradient-to-br from-[#1a2744] to-[#243660] rounded-2xl p-8">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <a
                key={i}
                href={project.href}
                className={`animate-on-scroll block bg-gradient-to-br ${project.color} rounded-2xl p-6 text-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300`}
