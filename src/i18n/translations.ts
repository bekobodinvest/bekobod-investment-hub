    ...
    about: {
      ...
      permits: {
        ...
        items: [
          ...
          { title: 'Customs Registration', description: 'Customs clearance and registration of imported equipment' },
          { title: 'Work Permits', description: 'Work permits and migration documents for foreign specialists (where required)' },
        ],
    ...
    about: {
      ...
      permits: {
        ...
        items: [
          ...
          { title: "Bojxona rasmiylashtiruvi", description: "Import qilingan uskunalarning bojxona rasmiylashtiruvi va ro'yxatdan o'tkazilishi" },
          { title: "Mehnat ruxsatnomasi", description: "Xorijiy mutaxassislar uchun mehnat faoliyati va migratsiya hujjatlari (zarur bo'lganda)" },
        ],
    ...
    about: {
      ...
      permits: {
        ...
        items: [
          ...
          { title: 'Таможенное оформление', description: 'Таможенное оформление и регистрация импортируемого оборудования' },
          { title: 'Разрешения на работу', description: 'Оформление разрешений на трудовую деятельность и миграционных документов для иностранных специалистов (при необходимости)' },
        ],
    ...
    about: {
      ...
      permits: {
        ...
        items: [
          ...
          { title: '海关通关', description: '进口设备的海关通关及登记注册' },
          { title: '工作许可', description: '为外籍专家办理工作许可证及移民文件（如需）' },
        ],
